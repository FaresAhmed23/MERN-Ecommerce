...
const AddProduct = () => {
	...
	return (
		<div className="p-8 box-border bg-white w-full rounded-sm mt-4 lg:m-7 flex flex-col justify-start items-center">
			<div className="mb-3">
				...
				<input
					...
					className="bg-primary outline max-w-80 w-full py-3 px-4 rounded-md"
				/>
			</div>
			<div className="mb-3">
